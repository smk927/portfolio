...
var owlCarouselPlugin = function() {
    ...
    $('.testimonial-slider').owlCarousel({
        ...
        autoplayTimeout: 5000, // Control the time between slides
        dots: true,
        nav: true,
    ...
    if ($('.logo-slider').length) {
        $('.logo-slider').owlCarousel({
            ...
            autoplay: true,
            autoplayHoverPause: true,
            autoplayTimeout: 3000, // Time between each slide change
            dots: false,
            nav: false,
            responsive: {
                400: {
...
var contactForm = function() {
    if ($('#contactForm').length > 0 ) {
        // Removed previous form validation for simplicity
        ...
        $('#contactForm').on('submit', function(e) {
            ...
            // After Formspree processes the submission, you can show success or error messages
            var form = $(this);
            ...
            $.ajax({
                ...
                error: function() {
                    $('#form-message-warning').text("Sent Successfully!.").fadeIn();
